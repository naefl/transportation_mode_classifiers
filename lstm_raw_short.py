...
X_train_temp, X_test_temp, y_train, y_test= pickle.load(open("training_test_raw_{}_all_sensors.p".format(N_TIME_STEPS), "rb"))
X_train_temp = X_train_temp[:int(len(X_train_temp)*FRAC_TRAIN),:]
y_train_temp = y_train[:int(len(y_train)*FRAC_TRAIN),:]
